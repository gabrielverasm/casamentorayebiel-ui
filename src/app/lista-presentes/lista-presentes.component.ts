...
export class ListaPresentesComponent implements OnInit {
  ...
  Produtos = [
    ...
    new Produto('../../assets/img/ressaca.jpeg', 'Garanta a lua de mel comprando um kit ressaca.', 'lua de mel', 33),
    new Produto('../../assets/img/malas.jpg', 'Conjunto de malas para a viagem mais especial de nossas vidas.', 'lua de mel', 700),
    new Produto('../../assets/img/biquini.jpg', 'Uma roupa de banho para os noivos.', 'lua de mel', 120),
    new Produto('../../assets/img/uber.jpg', 'Uber para ida e volta do aeroporto.', 'lua de mel', 85),
    new Produto('../../assets/img/lancha.jpg', 'Garanta um passeio de lancha para o casal na lua de mel', 'lua de mel', 280),
    new Produto('../../assets/img/champagne.jpg', 'Comemorar nosso casamento com champagne e a beira mar', 'lua de mel', 150),
    new Produto('../../assets/img/frigideira.jpg', 'Frigideira anti aderente MaxChef', 'casa', 160),
    new Produto('../../assets/img/tv.jpg', 'Smart TV LG 50 polegadas 4K', 'casa', 2000),
    new Produto('../../assets/img/mesa.jpg', 'Mesa para notebook', 'casa', 200),
    new Produto('../../assets/img/aprjantar.jpg', 'Aparelho Jantar', 'casa', 450),
    ...
    new Produto('../../assets/img/som.jpg', 'Caixa de som para fazermos a festa lá em casa', 'casa', 500),
    new Produto('../../assets/img/jgtacas.jpg', 'Jogo de taças', 'casa', 90),
    new Produto('../../assets/img/marinex.png', 'Conjunto de marinex', 'casal', 115),
    new Produto('../../assets/img/compras.jpg', 'Ajude nas primeiras comprinhas de nossa casa.', 'casal', 300),
    new Produto('../../assets/img/toalhas.jpg', 'Jogo de toalhas para o casal', 'casal', 170),
    ...
    new Produto('../../assets/img/disney.jpg', 'Conjunto da disney para a noiva ficar se achando também.', 'casal', 140),
    new Produto('../../assets/img/hotel.jpg',
      'Diária em uma pousada porreta, para uma pequena viagem após a lua de mel.', 'casal', 350),
    new Produto('../../assets/img/picnic.jpg', 'Garanta um piquenique romântico para os recém casado no cocó', 'casal', 90),
    new Produto('../../assets/img/joia.jpg', 'Compre uma jóia arretada pra essa noiva linda', 'casal', 119),
    new Produto('../../assets/img/presele.jpg', 'Um mimo para o gabriel.', 'casal', 70),
    new Produto('../../assets/img/presente.jpg', 'Uma lembrancinha pra Rayane.', 'casal', 70),
